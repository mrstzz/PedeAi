...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:atendente,garcom')->group(function () {
        ...
        Route::post('ticket-list/{ticketList}/pay', [TicketListController::class, 'pay'])->name('ticket-list.pay');
    ...
    Route::get('kitchen-queue', KitchenQueueController::class)->middleware('role:cozinha')->name('kitchen-queue.index');
    ...
    Route::middleware('role:administrador')->group(function () {
        ...
        Route::get('restaurant-tables/{restaurantTable}/edit', [RestaurantTableController::class, 'edit'])->name('restaurant-tables.edit');
        Route::patch('restaurant-tables/{restaurantTable}', [RestaurantTableController::class, 'update'])->name('restaurant-tables.update');
